...
% Select input video
inFile = fullfile(dataDir,['.avi']); % Change your data name oscillationnew4_original20(1)
[Path,FileName,Ext] = fileparts(inFile);
% 171.20240512_open、171.20250106、oscillationnew3_original
% Read video
...
% Set magnification parameter (vlog171.avi)
ScaleVideoSize = 1;
StartFrame = 1;
EndFrame   = nF;
alpha = 100;
...
% Set magnification parameter (coronal.avi)
% ScaleVideoSize = 1;
% StartFrame = 1;
% EndFrame   = nF;
% alpha = 30;
...
outName = fullfile(outputDir,'_FAF_100.avi');
